...
public class Islemler {
    ...
    private static void cikis() {
        System.out.println("  Okulumuza Yine Bekleriz Gule Gule  ");

    }

    private static void silme() { // silme isleme de tc ile yapilacak
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")){
            ...
            if (flag){ //eger girilen tc list de yoksa bu if calisir
            ...
            }if (flag){// kullanicinin girdigi tc kimlik no hic bir ogretmenle eslesmedi demek
    ...
    private static void arama() {
        ...
        if (kisiTuru.equalsIgnoreCase("OGRENCI")) {//bu satiirda ogrenci ariyorsa calisir
            ...
            for (Kisi w : ogrtmnList) {
                if (w.getKimlikNo().equals(arananKimlikNo)) {//kullanicinin girdigi tc ile ogrenci listinde ki tc lerden eslesen var mi
                    System.out.println("aradiginiz ogretmen " + w.getAdSoyad()); // kisi classin kullanidigi icin
                    flag = false;
                    break;
                }
            }
