...
public class JavaMathClassMethods {
    public static void main(String[] args) {
        ...
        System.out.println("round 3.1 i yuvarla = " + Math.round(3.1)); // 3 // round yuvarlamak demek     . sonra 5 ve uzeri ise uste yuvarlaniyor
        System.out.println("round 3.5 i yuvarla = " + Math.round(3.5)); // 4  --> bir uste yuvarlama        degilse asagiya yuvarlaniyor
        System.out.println("3.1 sayisinin ust tamsayiya yuvarlama = " + Math.ceil(3.1)); // 4 -> tavan  uste atiyor
        System.out.println("3.5 sayisinin ust tamsayiya yuvarlama = " + Math.ceil(3.5)); // 4
        System.out.println("3.1 sayisinin alt tamsayiya yuvarlama = " + Math.floor(3.1)); // 3 -> taban uste yuvarlaniyor
        System.out.println("3.5 sayisinin alt tamsayiya yuvarlama = " + Math.floor(3.5)); // 3    floor tam sayiyi aliyor geri kismi alinmiyor alta yuvarlaniyor
        ...
        /* int değerler üretme */
        int intSayi = (int) (Math.random()*100); // burada casting yapiyoruz
        ...
        // Java Math.Random Kullanimi    Rastgele 10 adet sayi uretiyoruz
