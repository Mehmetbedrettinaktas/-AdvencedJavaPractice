...
public class Q01_IlkVeSonkarekter {
    /*
    ...
    public static void main(String[] args) {
        ...
        // ilkSonHarf(str, sayi); metohduunu olsturuyoruz
        // iki parametreli bir method create ettik
    ...
    private static String ilkSonHarf(String str, int sayi) {
        ...
        String output = ""; // string output diye bir veriable olusturduk ve hiclik atadik
